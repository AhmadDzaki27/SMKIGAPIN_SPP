                ...
                <div class="col-md-12">
                  <div>
                    <center>
                      <p></p>
                      <div>
                      <img src="<?= base_url('dist/img/landing/LOGO_SMKIP.png') ?>" width="100" alt="" class="image-header">
                      </div>
                      <!-- <img src="<?= base_url('dist/img/landing/LOGO_SMKIP.png') ?>" width="95" alt="" class="image-header"> -->
                      <br>
                      ...
                      <h1 style="font-family: 'Times New Roman', Times, serif;"><b>SMKS IGASAR PINDAD</b></h2>
                      <p></p>
                    </center>
