                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <a href="<?= base_url('DataLaporanPemasukan/export/') . $this->input->get('tanggal_awal') . '/' . $this->input->get('tanggal_akhir')  ?>" class="btn btn-success">Export Excel</a>
                            <a href="<?= base_url('DataLaporanPemasukan/pdf/') . $this->input->get('tanggal_awal') . '/' . $this->input->get('tanggal_akhir')  ?>" class="btn btn-danger">Export PDF</a>
                        </div>
                    </div>
                </div>
            </div>
