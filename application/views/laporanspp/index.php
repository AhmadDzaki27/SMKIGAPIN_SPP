                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-8">
                            ...
                            <a href="<?= base_url('DataLaporanSPP/export/') . $this->input->get('ta') . '/' . $this->input->get('kelas') ?>" class="btn btn-success">Export Excel</a>
                            <a href="<?= base_url('DataLaporanSPP/pdf/') . $this->input->get('ta') . '/' . $this->input->get('kelas') ?>" class="btn btn-danger">Export PDF</a>
                        </div>
                    </div>
                </div>
            </div>
