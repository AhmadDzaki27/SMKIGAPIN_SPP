...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
  ...
  <a href="Welcome" class="brand-link">
    <img src="<?= base_url() ?>assets/dist/img/Logo_SMKIP.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
    ...
    <nav class="mt-2">
      <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
        ...
        <?php if ($this->session->userdata('level') == 'admin' || $this->session->userdata('level') == 'petugas') { ?>
          ...
          <!-- Data DPPSiswa-->
          <li class="nav-item">
            <a href="<?= base_url() ?>DataSPPSiswa" class="nav-link">
        ...
        <?php if ($this->session->userdata('level') == 'siswa') { ?>
          ...
          <li class="nav-item">
            <a href="<?= base_url() ?>DataSPPSiswa/detailTransaksi/<?= $this->session->userdata('id_user') ?>" class="nav-link">
