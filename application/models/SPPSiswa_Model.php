...
class SPPSiswa_Model extends CI_Model
{
	...
	{
		$this->db->select('tbl_siswa.nisn, nama_siswa, jk, tempat_lahir, tgl_lahir, alamat, no_telfon, tbl_jurusan.nama_jurusan, tbl_spp_siswa.nominal_dpp, tbl_spp_siswa.jumlah_angsuran, tbl_spp_siswa.nominal_angsuran, status');
	...
	{
		$this->db->select('tbl_siswa.nisn, nama_siswa, jk, tempat_lahir, tgl_lahir, alamat, no_telfon, tbl_jurusan.nama_jurusan, tbl_spp_siswa.nominal_dpp, tbl_spp_siswa.jumlah_angsuran, tbl_spp_siswa.nominal_angsuran, kelas_1, kelas_2, kelas_3');
		$this->db->from('tbl_siswa');
		$this->db->join('tbl_jurusan', 'tbl_siswa.kode_jurusan = tbl_jurusan.kode_jurusan');
		$this->db->join('tbl_spp_siswa', 'tbl_siswa.nisn = tbl_spp_siswa.nisn');
